// This script contains the SQL commands to update your Supabase database schema
// Copy and paste these commands into the Supabase SQL Editor (https://app.supabase.com/project/YOUR_PROJECT_REF/sql)
